 ...
 * @author ALUNO
 */
public class VisaoProjetos extends javax.swing.JFrame {

    /**
     * Creates new form TelaVisaoProjeto
     */
    public VisaoProjetos() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jRadioButton1.setText("Marcar no topo da lista");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Azul", "Amarelo", "Vermelho", "Roxo", "Laranja", "Rosa" }));

        botaoCriar.setBackground(new java.awt.Color(102, 255, 102));
        botaoCriar.setForeground(new java.awt.Color(0, 102, 0));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VisaoProjetos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VisaoProjetos().setVisible(true);
            }
        });
    }
