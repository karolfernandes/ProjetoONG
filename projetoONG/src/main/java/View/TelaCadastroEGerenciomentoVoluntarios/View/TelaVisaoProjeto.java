 ...
 * @author ALUNO
 */
public class TelaVisaoProjeto extends javax.swing.JFrame {

    /**
     * Creates new form TelaVisaoProjeto
     */
    public TelaVisaoProjeto() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaVisaoProjeto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaVisaoProjeto().setVisible(true);
            }
        });
    }
